...
output_csv_string_path = base_path + "cow_manual_reduced_string_krabbehartkamp.csv"
output_csv_value_path = base_path + "cow_manual_reduced_value_krabbehartkamp.csv"
