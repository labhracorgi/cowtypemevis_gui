...
base_path = "/Volumes/LaCie/pkl_output/out_csv/"
input_csv_path = base_path + "cow_type_automatic.csv"
output_csv_string_path = base_path + "cow_type_automatic_string.csv"
