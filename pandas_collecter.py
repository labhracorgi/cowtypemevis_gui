...
#Constant paths:
csv_output_path = "/Volumes/LaCie/to_be_traced/photometry_other/photometry_csv/cow_manual_type.csv"

base_path = "/Volumes/LaCie/to_be_traced/photometry/"

###Anything below here should not require modifications once it's complete!###

numpy_array_csv_paths = glob.glob(os.path.join(base_path,"*/3D_TOF/raw_type.csv"))
...
ID_labels_part_1 = [w.replace("/3D_TOF/raw_type.csv", "") for w in numpy_array_csv_paths] 
